...
# [ultraresearch local patch] Windows consoles default to a legacy codepage
# (e.g. cp949) that cannot encode em-dashes or Korean in --json/content output.
# Force UTF-8 so the engine never crashes at print on non-ASCII pages.
